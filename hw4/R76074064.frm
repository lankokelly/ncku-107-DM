...
Begin VB.Form Partition 
   ...
   Begin VB.CommandButton tbtn2 
      ...
      Width           =   1335
   End
   Begin VB.CommandButton scorebtn2 
      Caption         =   "score"
      BeginProperty Font 
         Name            =   "Consolas"
         Size            =   9
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  '透明
      Caption         =   "以bubble sort由大到小排序後，由數字大者選擇前n小"
      BeginProperty Font 
         Name            =   "Consolas"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label small 
      BackStyle       =   0  '透明
      Caption         =   "以bubble sort由大到小排序後，從數字小者選擇後n小(不重寫由小到大的bubble sort)"
      BeginProperty Font 
         Name            =   "Consolas"
         Size            =   9.75
         Charset         =   0
...
'score-------------------------------------------------------------------------------------------------
            ...
            Next x
            For x = 0 To 1999
                List1.AddItem "socre: " & score(x, 0) & Chr(9) & "seq:" & score(x, 1)
            Next
...
'--score排序-----------------------------------------------------------------------
            ...
            For x = 1 To 62
                For y = 1 To 62 '想像成另一張表的x
                    For k = 1950 To 1999 'scoreindex' '選後50小啦
                        a = score(k - 1, 1) '每個前50小的真正在data2的index
                        sumdis(x, y) = sumdis(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1900 To 1999 'scoreindex' '選後100小啦
                        a = score(k - 1, 1)
                        sumdis2(x, y) = sumdis2(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1850 To 1999 'scoreindex' '選後150小啦
                        a = score(k - 1, 1)
                        sumdis3(x, y) = sumdis3(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1800 To 1999 'scoreindex' '選後200小啦
                        a = score(k - 1, 1)
                        sumdis4(x, y) = sumdis4(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    classofcell(x, y) = data2(y, 0)
...
'--tvalue排序-----------------------------------------------------------------------
            ...
            For x = 1 To 62
                For y = 1 To 62 '想像成另一張表的x
                    For k = 1951 To 2000 'scoreindex' '選前50小啦
                        a = CInt(data(0, k))
                        sumdis(x, y) = sumdis(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1901 To 2000 'scoreindex' '選前100小啦
                        a = CInt(data(0, k))
                        sumdis2(x, y) = sumdis2(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1851 To 2000 'scoreindex' '選前150小啦
                        a = CInt(data(0, k))
                        sumdis3(x, y) = sumdis3(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    For k = 1801 To 2000 'scoreindex' '選前200小啦
                        a = CInt(data(0, k))
                        sumdis4(x, y) = sumdis4(x, y) + (CDbl(data2(x, a)) - CDbl(data2(y, a))) ^ 2
                    Next
                    classofcell(x, y) = data2(y, 0)
